...
datom handles cloud storage credentials (AWS keys, GitHub PATs). If you discover
a security vulnerability, **please do not open a public GitHub issue**.
...
You should receive a response within 7 days. We will coordinate a fix and
