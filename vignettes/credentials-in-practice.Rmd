...
datom never reads files for credentials and does not honor environment
...
The composite store -- one governance component, one data component,
plus the GitHub PAT and the two repo URLs:
...
cloned. One gov clone serves many data projects -- you only have one
gov repo per organization.
