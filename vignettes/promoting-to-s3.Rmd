...
infrastructure itself** — the gov GitHub repo and gov S3 bucket root.
These are shared across projects and datom does not destroy them
...
The gov S3 bucket content (`projects/STUDY_001/`) was already removed by
`datom_decommission()`. If the bucket is otherwise empty, delete it via
your AWS console or S3 management tooling.
