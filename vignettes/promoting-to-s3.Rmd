...
- A **prefix** within the bucket. For raw clinical data we recommend
  one bucket per study with an **empty prefix** at the bucket root.
  Derived data products (ADaM, TLF) then live under named prefixes
  (`adam/`, `tlf/`) in the same bucket. See
  [Buckets and Prefixes](buckets-and-prefixes.html) for the full
  convention and alternatives.
