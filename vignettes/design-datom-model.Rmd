...
> **Companion to**: [First Extract](first-extract.html). Read this when you
...
access can reproduce any historical analysis -- the metadata they need
is already on the data side, cached when the developer wrote.
...
- The two-repo split (governance vs. project) -- see
  [Two Repositories: Governance vs. Data](design-two-repos.html).
- The `ref.json` indirection layer -- see
