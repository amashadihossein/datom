...
**Status**: Chunk 7 complete; Chunk 8 next
**Started**: 2026-05-23
**Issue**: GitHub #24
...
| 8 | Mirror sync helper + repair story | Internal `.datom_sync_governance_json()` helper for repair after partial failures. Document in spec. | Sync test: mutate storage copy, run sync, assert restored from git copy. | ⏳ next |
