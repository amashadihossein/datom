...
| 5 | Refactor `datom_init_repo()` to gov-first ordering | ⏳ next | — |
| 6 | `datom_clone()` + `datom_pull()` two-repo semantics | not started | — |
