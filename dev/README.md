...
|------|---------|--------|----------|
| pre-cran-mechanical-fixes | 2026-07-12 | Active — items A-J done; spec completion pending (cran-comments deferred to post-#72) | [.kiro/specs/pre-cran-mechanical-fixes/](../.kiro/specs/pre-cran-mechanical-fixes/) |
