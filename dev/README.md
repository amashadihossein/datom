...
|------|---------|--------|----------|
| gov-seam-liftout (datom side) | 2026-06-13 | in progress: Task 2 done (datom_init_repo decoupled from gov, data-only) on `spec/gov-seam-liftout` | `.kiro/specs/gov-seam-liftout/` |
