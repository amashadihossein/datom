...
> which is the commit submitted as 0.1.2; `dev` (`17a84ce`, in the `../datom-cran-depends` worktree)
> and `spec/datom-sets` (`6fca896`) are both level with it, synced `main -> dev -> spec/datom-sets`;
