...
#> ℹ Created store directory /tmp/RtmprkodKH/datom-example-1b336265ede2/storage.
#> ✔ Initialized datom repository "example_project" at /tmp/RtmprkodKH/datom-example-1b336265ede2/repo
#> 
#> ── datom connection 
#> • Project: "example_project"
#> • Backend: "local"
#> • Role: "developer"
#> • Data root: "/tmp/RtmprkodKH/datom-example-1b336265ede2/storage"
#> • Governance: not attached
#> • Path: /tmp/RtmprkodKH/datom-example-1b336265ede2/repo
#> • Data repo: </tmp/RtmprkodKH/datom-example-1b336265ede2/remote.git>
#> 
#> ── datom connection 
#> • Project: "example_project"
#> • Backend: "local"
