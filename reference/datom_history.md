...
#> ℹ Created store directory /tmp/RtmpWbqD0Z/datom-example-198fe64da2/storage.
#> ✔ Initialized datom repository "example_project" at /tmp/RtmpWbqD0Z/datom-example-198fe64da2/repo
...
#> 1 2026-09-07T23:36:31Z datom <datom@noreply>      Update dm
```
